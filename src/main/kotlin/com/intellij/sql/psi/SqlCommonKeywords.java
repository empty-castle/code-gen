...
public interface SqlCommonKeywords {
  ...
  SqlTokenType SQL_CONTAINS = getType("CONTAINS", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_FREETEXT = getType("FREETEXT", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_GLOBAL = getType("GLOBAL", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_ILIKE = getType("ILIKE", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_MULTISET = getType("MULTISET", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_REGEXP = getType("REGEXP", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_RLIKE = getType("RLIKE", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_SOUNDS = getType("SOUNDS", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_STRUCT = getType("STRUCT", SqlKeywordTokenType.FACTORY);
  SqlTokenType SQL_SQL = getType("SQL", SqlKeywordTokenType.FACTORY);
  SqlTokenType SQL_SYS = getType("SYS", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_USE = getType("USE", SqlKeywordTokenType.FACTORY);
  ...
  SqlTokenType SQL_XOR = getType("XOR", SqlKeywordTokenType.FACTORY);
